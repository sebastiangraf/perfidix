...
public final class BenchFinder {
	 ...
	 * @param pm
	 */
	public static void findBenchsInContainer(Object[] elements,
			Set<IType> result, IProgressMonitor pm) {
		try {
	 ...
	 */
	private static void findBenchsInProject(IJavaProject project,
	 ...
	 * @throws JavaModelException
	 */
	private static void findBenchsInPackageFragment(IPackageFragment fragment,
			Set<IType> result) throws JavaModelException {
	 ...
	 * @throws JavaModelException
	 */
	private static void findBenchsInCompilationUnit(ICompilationUnit unit,
			Set<IType> result) throws JavaModelException {
	...
	private static class Annotation {
		...
		private static final BenchFinder.Annotation Bench = new BenchFinder.Annotation(
				new String[] { "Bench", "org.perfidix.Bench" }); //$NON-NLS-1$ //$NON-NLS-2$

		private static final BenchFinder.Annotation BenchClass = new BenchFinder.Annotation(
				new String[] { "BenchClass", "org.perfidix.BenchClass" });
