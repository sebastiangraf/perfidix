...
public class BenchViewCounterPanel extends Composite {
	...
	public BenchViewCounterPanel(Composite parent) {
		...
		benchFailures = createLabel("Failures: ", null, " 0 ");
	...
	public void setBenchRuns(int benchRuns, int ignored) {
		...
		this.benchRuns.setText(runString);
	...
	public void setBenchFailures(int benchFailures) {

		this.benchFailures.setText(Integer.toString(benchFailures));
		redraw();
	}
