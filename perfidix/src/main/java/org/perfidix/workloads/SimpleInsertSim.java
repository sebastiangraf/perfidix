...
public class SimpleInsertSim {
    ...
    /**
     * Get costs for a tree height 7 without caching 7 disk touches hasSpace
     * costs 1 disk touch. With caching 0 update costs 1 disk touch. With
     * caching 0 allocate cost 1 disk touch independent from cache
     * 
     * @param get
     * @param update
     * @param hasSpace
                ...
                if (prev < BUCKET_SIZE) {
                    ...
                    if (dataStructure[allocationIndex - 1] < BUCKET_SIZE) {
                        ...
                        dataStructure[allocationIndex - 1] =
                                (short) (dataStructure[allocationIndex - 1] + 1);
                        // costs
                        get();
                        hasSpace();
                        update();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            bench.add(new SimpleInsertSim(
                    getMeter, hasSpaceMeter, updateMeter, allocateMeter));
            ...
            /*
             * final AsciiTable v = new AsciiTable(); v.visit(res);
