...
public interface IMeter extends Comparable<IMeter> {
    ...
    abstract class AbstractMeter implements IMeter {
        ...
        /**
         * implements comparable. careful here. all ITimeMeters are sorted
         * _before_ any other meters. so when the given arraylist mixes time
         * meters and custom meters, the time meters will be always first.
         * 
         * @param o
    ...
    abstract class AbsTimeMeter extends IMeter.AbstractMeter {
        ...
        /**
         * returns the current time. depending on the subclass, the values of
         * this method will differ. usage example will be:
         * 
         * <pre>
