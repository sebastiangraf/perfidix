...
public class Benchmark {
    ...
    public final AbstractResult run(final int numInvocations) {
        ...
        // ResultContainer myResult = new BenchmarkResult();
    ...
    private MethodResult doRunObject(
        ...
        final Object[] args = {};
        final BenchmarkMethod elem = new BenchmarkMethod(m);
    ...
    private final class MeterHelper {
        ...
        // private MethodResult createMethodResult(final SingleResult
        // timedResult) {
        // if (timedResult != null) {
