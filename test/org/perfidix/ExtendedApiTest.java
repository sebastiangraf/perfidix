...
public class ExtendedApiTest extends PerfidixTest {
	...
	public void testVariance() {
		assertEquals(180.5, rc.variance());
	...
	public void testStandardDeviation() {
		assertEquals(9.5, rc.getStandardDeviation());
		assertEquals(0.0, rc
				.getStandardDeviation(Perfidix.getMeter("potatoes")));
		assertEquals(2.0, rc.getStandardDeviation(Perfidix.getMeter("carrots")));
	}
