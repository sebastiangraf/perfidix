...
public class ExtendedApiTest extends PerfidixTest {
    ...
    public void setUp() throws Exception {
        ...
        rc.append(new IResult.SingleResult("single 1", new long[] { 3 },
                carrots));
        rc.append(new IResult.SingleResult("single 2", new long[] { 7 },
                carrots));
        rc.append(new IResult.SingleResult("single 3", new long[] { 5 },
                potatoes));
    ...
    @Test
    public void testAvg() {
        assertEquals(20.5, rc.avg(), PerfidixTest.EPSILON);
        assertEquals(5.0, rc.avg(Perfidix.getMeter("potatoes")),
                PerfidixTest.EPSILON);
        assertEquals(5.0, rc.avg(Perfidix.getMeter("carrots")),
                PerfidixTest.EPSILON);
    ...
    public void testMean() {
        assertEquals(20.5, rc.mean(), PerfidixTest.EPSILON);
        assertEquals(5.0, rc.mean(Perfidix.getMeter("potatoes")),
                PerfidixTest.EPSILON);
        assertEquals(5.0, rc.mean(Perfidix.getMeter("carrots")),
                PerfidixTest.EPSILON);
    }

    @Test
    public void testMedian() {
        assertEquals(20.5, rc.median(), PerfidixTest.EPSILON);
        assertEquals(5.0, rc.median(Perfidix.getMeter("potatoes")),
                PerfidixTest.EPSILON);
        assertEquals(5.0, rc.median(Perfidix.getMeter("carrots")),
                PerfidixTest.EPSILON);
    }
    ...
    public void testConf99() {
        ...
        assertEquals(0.0, rc.getConf99(Perfidix.getMeter("potatoes")),
                PerfidixTest.EPSILON);
        assertEquals(3.643014, rc.getConf99(Perfidix.getMeter("carrots")),
                PerfidixTest.EPSILON);
    }
    ...
    public void testConf95() {
        ...
        assertEquals(0.0, rc.getConf95(Perfidix.getMeter("potatoes")),
                PerfidixTest.EPSILON);
        assertEquals(2.7718585, rc.getConf95(Perfidix.getMeter("carrots")),
                PerfidixTest.EPSILON);
    }

    @Test
    public void testVariance() {
        assertEquals(180.5, rc.variance(), PerfidixTest.EPSILON);
        assertEquals(0.0, rc.variance(Perfidix.getMeter("potatoes")),
                PerfidixTest.EPSILON);
        assertEquals(8.0, rc.variance(Perfidix.getMeter("carrots")),
                PerfidixTest.EPSILON);
    }
    ...
    public void testStandardDeviation() {
        assertEquals(9.5, rc.getStandardDeviation(), PerfidixTest.EPSILON);
        assertEquals(0.0, rc
                .getStandardDeviation(Perfidix.getMeter("potatoes")),
                PerfidixTest.EPSILON);
        assertEquals(2.0,
                rc.getStandardDeviation(Perfidix.getMeter("carrots")),
                PerfidixTest.EPSILON);
    }
