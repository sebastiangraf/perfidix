...
public class RandomResultTest extends PerfidixTest {
    ...
    public void testTwo() {
        ...
        assertEquals(5.0, container.avg(), PerfidixTest.EPSILON);
        ...
        assertEquals(whatEver.getStandardDeviation(), container
                .getStandardDeviation(), PerfidixTest.EPSILON);
    ...
    public void testFour() {
        ...
        assertEquals(r1.avg(), r2.avg(), PerfidixTest.EPSILON);
        assertEquals(r1.getConf95(), r2.getConf95(), PerfidixTest.EPSILON);
        assertEquals(r1.getConf99(), r2.getConf99(), PerfidixTest.EPSILON);
